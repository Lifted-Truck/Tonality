...
Tonality is built to be *consumed*. Three transports expose the **same 78 tools**
...
| **MCP server** | LLM agents (Claude & others) | `python -m mts.mcp` — 78 tools, one per analysis entry point |
