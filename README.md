...
Tonality is built to be *consumed*. Three transports expose the **same 71 tools**
...
| **MCP server** | LLM agents (Claude & others) | `python -m mts.mcp` — 71 tools, one per analysis entry point |
