...
Tonality is built to be *consumed*. Three transports expose the **same 79 tools**
...
| **MCP server** | LLM agents (Claude & others) | `python -m mts.mcp` — 79 tools, one per analysis entry point |
